...
The `ce:work` skill is for executing work efficiently while maintaining quality and finishing features.
...
2. **Assess complexity and route**
   ...
   | **Large** | Cross-cutting, architectural decisions, 10+ files, touches auth/payments/migrations | Inform the user this would benefit from `/prompts:ce-brainstorm` or `/prompts:ce-plan` to surface edge cases and scope boundaries. Honor their choice. If proceeding, build a task list and continue to Phase 1 step 2 |
