---
name: claudemd
description: Guidance for generating and maintaining CLAUDE.md project instruction files, with a Remotion-focused reference and component rules.
---
...
The `claudemd` skill covers guidance for generating and maintaining CLAUDE.md project instruction files, with a Remotion-focused reference and component rules.

Guidance for generating and maintaining CLAUDE.md project instruction files, with a Remotion-focused reference and component rules.
